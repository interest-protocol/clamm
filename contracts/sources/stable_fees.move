module clamm::stable_fees {
  ...
  struct StableFees has store, copy, drop {
    fee_in_percent: u256,
  ...
  public fun update_fee_out_percent(fee: &mut StableFees, fee_out_percent: Option<u256>) {
  ...
  public fun update_admin_fee_percent(fee: &mut StableFees, admin_fee_percent: Option<u256>) {
