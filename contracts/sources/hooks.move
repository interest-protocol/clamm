module clamm::hooks {
  ...
  public fun finish_swap<Curve>(pool: &InterestPool<Curve>, request: Request): Request {
    assert!(pool.has_swap_hook(), errors::this_pool_has_no_hooks());
  ...
  public fun finish_add_liquidity<Curve>(pool: &InterestPool<Curve>, request: Request): Request {
    assert!(pool.has_add_liquidity_hook(), errors::this_pool_has_no_hooks());
    assert!(
  ...
  public fun finish_remove_liquidity<Curve>(pool: &InterestPool<Curve>, request: Request): Request {
    assert!(pool.has_remove_liquidity_hook(), errors::this_pool_has_no_hooks());
    assert!(
