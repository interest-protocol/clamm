module amm::pool_events {
  ...
  use amm::curves::{StablePair, Volatile};

  friend amm::volatile;
  friend amm::stable_pair;
  friend amm::stable_tuple;

  struct NewPair<phantom Curve, phantom CoinX, phantom CoinY, phantom LpCoin> has drop, copy {
    pool_id: ID,
    amount_x: u64,
    amount_y: u64
  }
  ...
  struct AddLiquidity<phantom Curve, phantom CoinX, phantom CoinY, phantom LpCoin> has drop, copy {
    pool_id: ID,
    amount_x: u64,
    amount_y: u64,
    shares: u64
  ...
  struct RemovePairLiquidity<phantom Curve, phantom CoinX, phantom CoinY, phantom LpCoin> has drop, copy {
    pool_id: ID,
    amount_x: u64,
    amount_y: u64,
    shares: u64
  ...
  struct TakeStablePairFees<phantom Curve, phantom CoinX, phantom CoinY, phantom LpCoin> has copy, drop {
    pool_id: ID,
    amount_x: u64,
    amount_y: u64
  }
  ...
  public(friend) fun emit_new_pair<Curve, CoinX, CoinY, LpCoin>(pool_id: ID, amount_x: u64, amount_y: u64) {
    emit(NewPair<Curve, CoinX, CoinY, LpCoin>{ pool_id, amount_x, amount_y });
  }
  ...
  public(friend) fun emit_add_pair_liquidity<Curve, CoinX, CoinY, LpCoin>(pool_id: ID, amount_x: u64, amount_y: u64, shares: u64) {
   emit(AddLiquidity<Curve, CoinX, CoinY, LpCoin>{ pool_id, amount_x, amount_y, shares });    
  }
  ...
  public(friend) fun emit_remove_pair_liquidity<Curve, CoinX, CoinY, LpCoin>(pool_id: ID, amount_x: u64, amount_y: u64, shares: u64) {
    emit(RemovePairLiquidity<Curve, CoinX, CoinY, LpCoin>{ pool_id, amount_x, amount_y, shares});
  }
  ...
  public(friend) fun emit_take_stable_pair_fees<CoinX, CoinY, LpCoin>(pool_id: ID, amount_x: u64, amount_y: u64 ) {
    emit(TakeStablePairFees<StablePair, CoinX, CoinY, LpCoin> { pool_id, amount_x, amount_y });
  }  
