...
module clamm::volatile_3pool_add_liquidity_tests {
  ...
  fun mints_correct_lp_coin_amount() {
    ...
    next_tx(test, bob);
    {
      ...
      assert_eq(interest_clamm_volatile::lp_coin_supply<LP_COIN>(&mut pool), 480377433096);
      assert_eq(
        interest_clamm_volatile::balances<LP_COIN>(&mut pool),
  ...
  fun mints_correct_lp_after_swap() {
    ...
    next_tx(test, alice);
    {
      ...
      assert_eq(interest_clamm_volatile::lp_coin_supply<LP_COIN>(&mut pool), 586029756384);
     ...
     assert_eq(
      ...
      assert_eq(interest_clamm_volatile::lp_coin_supply<LP_COIN>(&mut pool), 693824797654);
