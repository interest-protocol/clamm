...
module clamm::volatile_no_hooks_tests {
 ...
 //     destroy(interest_clamm_volatile::swap<DAI, USDC, LP_COIN>(
 //      &mut pool,
 //       &c,
 ...
 //     destroy(interest_clamm_volatile::add_liquidity_2_pool<USDC, DAI, LP_COIN>(
 //      &mut pool,
 //       &c,
 ...
 //     destroy(interest_clamm_volatile::add_liquidity_3_pool<USDC, DAI, USDT, LP_COIN>(
 //      &mut pool,
 //       &c,
 //       mint<USDC>(344, USDC_DECIMALS, ctx(test)),
 //       mint<DAI>(344, DAI_DECIMALS, ctx(test)),
 ...
 //     let (coin_a, coin_b) = interest_clamm_volatile::remove_liquidity_2_pool<USDC, DAI, LP_COIN>(
 //       &mut pool,
 ...
 //     let (coin_a, coin_b, coin_c) = interest_clamm_volatile::remove_liquidity_3_pool<USDC, DAI, USDT, LP_COIN>(
 //       &mut pool,
 //       mint<LP_COIN>(344, LP_COIN_DECIMALS, ctx(test)),
 //       vector[0, 0, 0],
 //       ctx(test)
