...
#[test_only]
module clamm::stable_tuple_3pool_remove_liquidity_tests { 
  use sui::clock;
  ...
  fun remove_liquidity() {
    ...
    next_tx(test, alice);    
    {
      ...
      let(coin_dai, coin_usdc, coin_usdt) = interest_amm_stable::remove_liquidity_3_pool<DAI, USDC, USDT, LP_COIN>(
        &mut pool,
