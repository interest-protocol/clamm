...
math: immutable(address)
views: immutable(address)
token: immutable(address)
coins: immutable(address[3])
...
def tweak_price(A_gamma: uint256[2],
    ...
    data: uint256 = block.timestamp - last_prices_timestamp

    print("time", data, hardhat_compat=True)    
...
def _calc_withdraw_one_coin(A_gamma: uint256[2], token_amount: uint256, i: uint256, update_D: bool,
    ...
    assert i < 3  # dev: coin out of range
